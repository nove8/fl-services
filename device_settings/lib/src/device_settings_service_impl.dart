...
part 'mapper/device_settings_type_mapper.dart';
...
final class DeviceSettingsServiceImpl implements DeviceSettingsService {
  ...
  static const _DeviceSettingsTypeServiceToLibMapper _settingsTypeMapper =
      _DeviceSettingsTypeServiceToLibMapper();
