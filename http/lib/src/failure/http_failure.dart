...
sealed class UnsuccessfulHttpStatusCodeFailure implements HttpFailure {
  ...
  const UnsuccessfulHttpStatusCodeFailure({
  ...
  @override
  String toString() {
    return 'UnsuccessfulHttpStatusCodeFailure{statusCode: $statusCode, reasonPhrase: $reasonPhrase, bodyBytes: $bodyBytes}';
  }
}
...
final class ClientErrorHttpStatusCodeFailure extends UnsuccessfulHttpStatusCodeFailure {
  ...
  @override
  String toString() {
    return 'ClientErrorHttpStatusCodeFailure{statusCode: $statusCode, reasonPhrase: $reasonPhrase, bodyBytes: $bodyBytes}';
  }
}
...
final class ServerErrorHttpStatusCodeFailure extends UnsuccessfulHttpStatusCodeFailure {
  ...
  @override
  String toString() {
    return 'ServerErrorHttpStatusCodeFailure{statusCode: $statusCode, reasonPhrase: $reasonPhrase, bodyBytes: $bodyBytes}';
  }
}
...
final class InformationOrRedirectionHttpStatusCodeFailure extends UnsuccessfulHttpStatusCodeFailure {
  ...
  @override
  String toString() {
    return 'InformationOrRedirectionHttpStatusCodeFailure{statusCode: $statusCode, reasonPhrase: $reasonPhrase, bodyBytes: $bodyBytes}';
  }
}
...
/// Failure that occurs when an HTTP request exceeds the configured timeout.
